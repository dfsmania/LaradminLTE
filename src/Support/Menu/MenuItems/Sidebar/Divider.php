...
class Divider extends LeafMenuItem
{
    ...
    protected static function makeBladeComponent(
        ...
        return new Layout\Sidebar\Divider(color: $config['color'] ?? null);
    }
}
