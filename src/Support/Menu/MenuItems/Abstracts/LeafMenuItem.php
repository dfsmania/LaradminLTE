...
namespace DFSmania\LaradminLte\Support\Menu\MenuItems\Abstracts;
...
use DFSmania\LaradminLte\Support\Menu\Contracts\BuildableFromConfig;
 ...
 */
abstract class LeafMenuItem implements BuildableFromConfig, MenuItem
{
    /**
