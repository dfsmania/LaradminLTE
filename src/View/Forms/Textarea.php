...
class Textarea extends Component
{
    ...
    /**
     * The name attribute of the textarea element, also used as the default
     * "id" attribute when no other is provided.
     *
     * @var string
     */
    public string $name;
    ...
    /**
     * Whether to show validation feedback style on the textarea element. This
     * is useful when the textarea is used in a form that requires validation.
     *
     * @var bool
     */
     ...
     * @param  ?string  $id  The id attribute of the textarea element
    ...
    {
        return view('ladmin::forms.textarea');
    }
}
