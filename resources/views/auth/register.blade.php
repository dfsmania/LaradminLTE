        ...
        <div class="card-body login-card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="w-100 clearfix">
                    <x-ladmin-button type="submit" theme="{{ $buttonTheme }}" label="{{ __('ladmin::auth.register.register') }}"
                        icon="bi bi-person-plus-fill fs-5 me-1" class="float-end d-flex align-items-center bg-gradient"/>
                </div>
